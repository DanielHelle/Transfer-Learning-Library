...
#SVHN 1ipc --> MNISTRGB
CUDA_VISIBLE_DEVICES=0 python jan.py data/digits -d Digits -s SVHNRGB -t MNISTRGB -a convnet -b 2 --seed 0 --epochs 40 --norm-mean 0.485 --norm-std 0.229 --resize-size 32 --train-resizing res. --val-resizing res. --log logs/jan/experiment/Digits_S2M/1ipc/ --dataset-condensation True --condensed-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/1ipc/res_DC_pre_processed_svhn_ConvNet_1ipc.pt --convnet-weights-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/1ipc/state_dict_DC_pre_processed_svhn_ConvNet_1ipc.pt

#SVHN 10ipc --> MNSITRGB
CUDA_VISIBLE_DEVICES=0 python jan.py data/digits -d Digits -s SVHNRGB -t MNISTRGB -a convnet -b 3 --seed 0 --epochs 60 --norm-mean 0.485 --norm-std 0.229 --resize-size 32 --train-resizing res. --val-resizing res. --log logs/jan/experiment/Digits_S2M/10ipc/ --dataset-condensation True --condensed-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/10ipc/res_DC_pre_processed_svhn_ConvNet_10ipc.pt --convnet-weights-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/10ipc/state_dict_DC_pre_processed_svhn_ConvNet_10ipc.pt

#SVHN 1ipc --> USPSRGB
CUDA_VISIBLE_DEVICES=0 python jan.py data/digits -d Digits -s SVHNRGB -t USPSRGB -a convnet -b 2 --seed 0 --epochs 40 --norm-mean 0.485 --norm-std 0.229 --resize-size 32 --train-resizing res. --val-resizing res. --log logs/jan/experiment/Digits_S2U/1ipc/ --dataset-condensation True --condensed-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/1ipc/res_DC_pre_processed_svhn_ConvNet_1ipc.pt --convnet-weights-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/1ipc/state_dict_DC_pre_processed_svhn_ConvNet_1ipc.pt

#SVHN 10ipc --> USPSRGB
CUDA_VISIBLE_DEVICES=0 python jan.py data/digits -d Digits -s SVHNRGB -t USPSRGB -a convnet -b 3 --seed 0 --epochs 60 --norm-mean 0.485 --norm-std 0.229 --resize-size 32 --train-resizing res. --val-resizing res. --log logs/jan/experiment/Digits_S2U/10ipc/ --dataset-condensation True --condensed-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/10ipc/res_DC_pre_processed_svhn_ConvNet_10ipc.pt --convnet-weights-data-path /home/daniel/exjobb/DatasetCondensation/result/condensed_svhn/10ipc/state_dict_DC_pre_processed_svhn_ConvNet_10ipc.pt
